...
export default function DentalPage() {
  ...
  const dentalTestimonials = [
    {
      name: "Maria Garcia",
      text: "The dental implant procedure was incredible! I can't believe how natural it looks and feels. The team made the entire process comfortable and stress-free. I'm so happy with my new smile and can bite and chew with ease!",
      rating: 5,
    ...
    {
      name: "James Wilson",
      text: "My smile makeover exceeded all expectations. The transformation is amazing and I feel so much more confident. The 90-minute procedure was quick and the attention to detail was exceptional throughout.",
      rating: 5,
    ...
    {
      name: "Lisa Thompson",
      text: "The laser teeth whitening treatment was quick and painless. My smile is now several shades brighter and the results have lasted for over a year. Highly recommend CLINICA for their expertise!",
      rating: 5,
    ...
    {
      name: "David Chen",
      text: "The root canal treatment was completely painless! I was so nervous but the team made me feel comfortable throughout. The 30-minute procedure was quick and efficient. No more dental fear!",
      rating: 5,
    ...
    {
      name: "Sarah Johnson",
      text: "My orthodontic treatment with clear aligners was amazing. They're virtually invisible and I can take them out when needed. The results are perfect and the treatment was comfortable!",
      rating: 5,
