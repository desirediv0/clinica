...
export default function HomePage() {
  ...
  const skinTreatments = [
    ...
    {
      title: "Skin Tag and Mole Removal",
      description:
        "Safe and effective removal of unwanted skin tags and moles using advanced techniques. Our experts ensure minimal discomfort and optimal aesthetic results.",
      icon: CheckCircle,
      ...
      recovery: "1-2 days",
      details:
        "We use state-of-the-art equipment for precise removal of skin tags and moles, ensuring clean results with minimal recovery time.",
    },
    {
